import{_ as s,c as n,o as a,a2 as p}from"./chunks/framework.DQS5QPof.js";const g=JSON.parse('{"title":"RSS动态卡片","description":"","frontmatter":{},"headers":[],"relativePath":"guide/home/rss.md","filePath":"guide/home/rss.md"}'),e={name:"guide/home/rss.md"},l=p(`<h1 id="rss动态卡片" tabindex="-1">RSS动态卡片 <a class="header-anchor" href="#rss动态卡片" aria-label="Permalink to &quot;RSS动态卡片&quot;">​</a></h1><p>和首页的效果是一致的，这里我们引入在侧边栏中</p><h2 id="特征" tabindex="-1">特征 <a class="header-anchor" href="#特征" aria-label="Permalink to &quot;特征&quot;">​</a></h2><ul><li>页面加载2秒后自动从右侧弹出</li><li>每隔8秒更换展示订阅标题+日期，可点击进入链接</li><li>支持多个rss源的引入</li><li>带有关闭按钮，点击后即可关闭</li></ul><p><img src="https://jsd.cdn.noisework.cn/gh/rcy1314/tuchuang@main/uPic/rss2.png" alt="rss2"></p><h2 id="使用" tabindex="-1">使用 <a class="header-anchor" href="#使用" aria-label="Permalink to &quot;使用&quot;">​</a></h2><p>除了需要在页面内引入相应的JS和css文件，还需要在body中引入</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;!-- rss订阅文字代码--&gt;</span></span>
...
<span class="line"><span>});</span></span>
<span class="line"><span>});</span></span>
<span class="line"><span>}, 3600000); // 每隔1小时检查一次RSS源是否有更新</span></span></code></pre></div>`,16),t=[l];function i(c,r,o,d,u,m){return a(),n("div",null,t)}const v=s(e,[["render",i]]);export{g as __pageData,v as default};
