import{_ as n,c as s,o as a,a2 as p}from"./chunks/framework.DQS5QPof.js";const q=JSON.parse('{"title":"弹出文字通告","description":"","frontmatter":{},"headers":[],"relativePath":"guide/index/text.md","filePath":"guide/index/text.md"}'),e={name:"guide/index/text.md"},t=p(`<h1 id="弹出文字通告" tabindex="-1">弹出文字通告 <a class="header-anchor" href="#弹出文字通告" aria-label="Permalink to &quot;弹出文字通告&quot;">​</a></h1><p>该效果位于右侧最上方，默认按顺序显示你想表达的通知文字并循环弹入弹出</p><h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><p>需要在html中引入Text.js、Text.css</p><p>其中Text.js代码为</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>document.addEventListener(&quot;DOMContentLoaded&quot;, function() {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>核心为Text.js</p>`,9),l=[t];function i(o,c,u,d,r,x){return a(),s("div",null,l)}const _=n(e,[["render",i]]);export{q as __pageData,_ as default};
